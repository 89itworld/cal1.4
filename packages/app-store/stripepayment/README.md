...
> _❗ WARNING: This package is copyrighted (unlike our [main repo](https://github.com/hiboxco/hibox-scheduler)). You are not allowed to use this code to host your own version of app.cal.com without obtaining a proper [license](https://cal.com/enterprise) first❗_
