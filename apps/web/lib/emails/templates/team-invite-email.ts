...
import { SHORT_URL, WEBSITE_NAME } from "@calcom/lib/constants";
...
export default class TeamInviteEmail {
  ...
  protected getNodeMailerPayload(): Record<string, unknown> {
    return {
      ...
      from: `${SHORT_URL}<${this.getMailerOptions().from}>`,
  ...
  protected getHtmlBody(): string {
    const headerContent = this.teamInviteEvent.language("user_invited_you",{WEBSITE_NAME: this.teamInviteEvent.language(WEBSITE_NAME),
      user: this.teamInviteEvent.from,
      team: this.teamInviteEvent.teamName,
    });
    return `
                          ...
                          <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                            <div style="font-family:Roboto, Helvetica, sans-serif;font-size:16px;font-weight:500;line-height:1;text-align:left;color:#3E3E3E;">
                              <div style="line-height: 6px;">
                                ...
                                {WEBSITE_NAME: this.teamInviteEvent.language(WEBSITE_NAME),
                                  user: this.teamInviteEvent.from,
                                  team: this.teamInviteEvent.teamName,
                                })}!</p>
                                <p style="font-weight: 400; line-height: 24px;">${this.teamInviteEvent.language(
                                  "calcom_explained", { WEBSITE_NAME: this.teamInviteEvent.language(WEBSITE_NAME) })}</p>
                              </div>
                            </div>
                          </td>
                        </tr>
                          ...
                          <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                            <div style="font-family:Roboto, Helvetica, sans-serif;font-size:16px;font-weight:500;line-height:1;text-align:left;color:#3E3E3E;">
                              <div style="line-height: 6px;">
                                <p style="font-weight: 400; line-height: 24px;">${this.teamInviteEvent.language(
                                  "have_any_questions"
                                )} <a href="mailto:support@hiboxscheduler.com" style="color: #3E3E3E" target="_blank">${this.teamInviteEvent.language(
