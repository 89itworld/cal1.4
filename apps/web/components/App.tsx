          ...
          <div className="justify-between px-10 py-10 md:flex">
            ...
            <div className="md:max-w-80 flex-1 md:ml-8">
              ...
              <small className="leading-1 block text-gray-500">
                Every app published on the {WEBSITE_NAME} App Store is open source and thoroughly tested via peer
                reviews. Nevertheless, {WEBSITE_NAME}, LLC. does not endorse or certify these apps unless they are
                published by {WEBSITE_NAME}. If you encounter inappropriate content or behaviour please report it.
              </small>
              <a className="mt-2 block text-xs text-red-500" href="mailto:help@hiboxscheduler.com">
