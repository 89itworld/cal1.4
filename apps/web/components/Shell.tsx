...
import { NEXT_PUBLIC_BASE_URL, WEBSITE_URL, BASE_URL } from "@lib/config/constants";
...
export default function Shell(props: {
  ...
  return (
    <>
      ...
      <HeadSeo
        title={pageTitle ?? "Hiboxscheduler.com"}
            ...
            <div className="flex w-14 flex-col lg:w-56">
              <div className="flex h-0 flex-1 flex-col border-r border-gray-200 bg-white">
                ...
                <small style={{ fontSize: "0.5rem" }} className="mx-3 mt-1 mb-2 hidden opacity-50 lg:block">
                  &copy; {new Date().getFullYear()} Hiboxscheduler, LLC. v.{pkg.version + "-"}
                  {process.env.NEXT_PUBLIC_APP_URL === process.env.NEXT_PUBLIC_APP_URL ? "h" : "sh"}
            ...
            <span className="flex flex-grow items-center truncate">
              <span className="flex-grow truncate text-sm">
                ...
                <span className="block truncate font-normal text-neutral-500">
                  {user?.username ? `${WEBSITE_URL}/${user.username}` : "No public page"}
                </span>
              </span>
              <SelectorIcon
      ...
      <DropdownMenuContent portalled={true}>
        ...
        <DropdownMenuItem>
          <a
            target="_blank"
            rel="noopener noreferrer"
            href ={`${process.env.NEXT_PUBLIC_BASE_URL}/roadmap`}
            className="flex items-center px-4 py-2 text-sm text-gray-700">
