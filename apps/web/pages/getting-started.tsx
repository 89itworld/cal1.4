...
export default function Onboarding(props: inferSSRProps<typeof getServerSideProps>) {
  ...
  const steps = [
    {
      id: t("welcome"),
      title: t("welcome_to_calcom",{WEBSITE_NAME:t(WEBSITE_NAME)}),
          ...
          {selectedImport && (
            <div>
              ...
              <p className="mb-2 text-sm text-gray-500">
                ...
                <a href="https://docs.hiboxscheduler.com/import">here</a>.
              </p>
              <form
                className="flex"
          ...
          <section className="mx-auto max-w-xl py-8">
            <div className="flex flex-row-reverse justify-between">
              <button
                ...
                className="text-sm leading-tight text-grayi-500 dark:text-white">
                {t("next_step")}
              </button>
              {currentStep !== 0 && (
                <button
