...
import { BASE_URL, WEBSITE_NAME } from "@calcom/lib/constants";
                ...
                <div
                  ...
                  {!props.hideBranding && (
                    <div className="pt-4 text-center text-xs text-gray-400 dark:border-gray-900 dark:text-white">
                     <a href = {`${BASE_URL}/signup`}>{t("create_booking_link_with_calcom",{ WEBSITE_NAME: t(WEBSITE_NAME) })}</a>

                      <form
                        onSubmit={(e) => {
                          e.preventDefault();
                          router.push(BASE_URL+`/signup?email=` + (e as any).target.email.value);
                        }}
                        className="mt-4 flex">
                        <EmailInput
                          name="email"
                          ...
                          placeholder="mark@hiboxscheduler.com"
                        />
