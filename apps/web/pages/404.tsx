...
import { WEBSITE_NAME, WEBSITE_URL } from "@calcom/lib/constants";
...
export default function Custom404() {
  ...
  const isCalcom = process.env.NEXT_PUBLIC_BASE_URL === "https://scheduler.hibox.co";
    ...
    <>
      ...
      <div className="min-h-screen bg-white px-4" data-testid="404-page">
        <main className="mx-auto max-w-xl pt-16 pb-6 sm:pt-24">
          {isSignup && process.env.NEXT_PUBLIC_BASE_URL !== "https://scheduler.hibox.co" ? (
            <div>
              <div>
                ...
                <p className="mt-4">{t("signup_requires_description",{ WEBSITE_NAME: t(WEBSITE_NAME) })}</p>
              </div>
              <div className="mt-12">
                ...
                <ul role="list" className="mt-4">
                  <li className="border-2 border-green-500 px-4 py-2">
                    <a
                      href="https://hiboxscheduler.com/pricing?infra"
                ...
                <ul role="list" className="divide-y divide-gray-200 border-gray-200">
                  <li className="px-4 py-2">
                    <Link href="https://docs.hiboxscheduler.com/self-hosting/install#setting-up-your-first-user">
                ...
                <div className="mt-8">
                  <Link href="https://hiboxscheduler.com/enterprise">
                ...
                {isSubpage ? (
                  ...
                  <Link href={url}>
                    <a className="mt-2 inline-block text-lg">
                      {t("the_username")} <strong className="text-blue-500">hiboxscheduler.com{username}</strong>{" "}
