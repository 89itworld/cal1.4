...
export default function JoinCall(props: JoinCallPageProps) {
  ...
  return (
    <>
      <Head>
        <title>{WEBSITE_NAME} Video</title>
        <meta name="title" content= {t(WEBSITE_NAME + "Video")} />
        <meta name="description" content={t("quick_video_meeting")} />
        <meta property="og:image" content={t(BASE_URL + "/video-og-image.png")} />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={t(BASE_URL + "/video")} />
        <meta property="og:title" content={t(WEBSITE_NAME + "Video")} />
        <meta property="og:description" content={t("quick_video_meeting")} />
        <meta property="twitter:image" content= {t(BASE_URL + "/video-og-image.png")} />
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content={t(BASE_URL+"/video")} />
        <meta property="twitter:title" content= {t(WEBSITE_NAME + "Video")} />
