...
function SettingsView(props: ComponentProps<typeof Settings> & { localeProp: string }) {
  ...
  const deleteAccount = async () => {
    ...
    if (process.env.NEXT_PUBLIC_BASE_URL === "https://scheduler.hibox.co") {
            ...
            <div>
              ...
              {/*   <div className="text-sm ltr:ml-3 rtl:mr-3">
                  <label htmlFor="hide-branding" className="font-medium text-gray-700">
                    {t("disable_cal_branding",{ WEBSITE_NAME: t(WEBSITE_NAME) })}{" "}
                    {props.user.plan !== "PRO" && <Badge variant="default">PRO</Badge>}
                  </label>
                  <p className="text-gray-500">{t("disable_cal_branding_description",{ WEBSITE_NAME: t(WEBSITE_NAME) })}</p>
                </div> */}
              </div>
            </div>
              ...
              <div className="relative flex items-start">
                <Dialog>
                  ...
                  <ConfirmationDialogContent
                    ...
                    {t("delete_account_confirmation_message",{ WEBSITE_NAME: t(WEBSITE_NAME) })}
                  </ConfirmationDialogContent>
                </Dialog>
              </div>
            </div>
