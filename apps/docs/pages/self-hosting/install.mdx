...
1.  Set a 32 character random string in your `apps/web/.env` file for the `HIBOX_ENCRYPTION_KEY` (You can use a command like `openssl rand -base64 24` to generate one).
