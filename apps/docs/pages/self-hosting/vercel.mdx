...
2. Copy the `.env.example` file in `apps/web`, rename it to `.env` and fill it with your settings ([See manual setup](https://github.com/hiboxco/hibox-scheduler#manual) and [Obtaining the Google API Credentials](https://github.com/hiboxco/hibox-scheduler#obtaining-the-google-api-credentials))
